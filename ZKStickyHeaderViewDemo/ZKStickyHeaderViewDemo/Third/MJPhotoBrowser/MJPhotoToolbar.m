...
- (void)image:(UIImage *)image didFinishSavingWithError:(NSError *)error contextInfo:(void *)contextInfo
{
    if (error) {
        ...
        hud.label.text = @"保存失败";
        // 设置图片
        hud.customView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:[NSString stringWithFormat:@"MJPhotoBrowser.bundle/%@", @"error"]]];
        // 再设置模式
        ...
        // 设置图片
        hud.customView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:[NSString stringWithFormat:@"MJPhotoBrowser.bundle/%@", @"success"]]];
        // 再设置模式
        hud.mode = MBProgressHUDModeCustomView;
